...
|---|---|---|
| [promachina/iut-lean](https://github.com/promachina/iut-lean/commit/581e2b898b8429cbb696f75c4548e732d440650d), production snapshot `0d52e0fd`, refreshed HEAD `581e2b89` checked 2026-08-04 | 189 Lean files. The source-facing anabelioid, glued finite-etale, Galois-level, combinatorial universal-cover, tempered-cover, and Theorem-3.11 surfaces are the closest public implementation. Commit `04ffcc8e` adds real countable-base/finite-fiber proofs; `ca36ee8d` adds finite semigraph and categorical comparison kernels; `c8c4a4b4` and `18e1ad97` add an Andre exact-sequence boundary and arithmetic tempered-tower wrapper. | Selective reuse only. The 27-file foundation closure is ported to Mathlib 4.32.2 and audited locally, and the exact countable-base patch through `36ef280d` is adopted. The new Andre exactness/completion facts, stable-log specialization, level exactness, and inverse-limit surjectivity/inducing facts remain record fields. Only their generic quotient/inverse-limit consequences are candidates for extraction. |
