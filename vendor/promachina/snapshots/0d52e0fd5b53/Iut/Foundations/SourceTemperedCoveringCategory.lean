...
noncomputable def actionComponentMap
  ...
  Quotient.map' map.hom.hom (by
    ...
    refine ⟨element, ?_⟩
    rw [← equality]
    simpa only [SourceCountableTypeCat.comp_apply] using
      ...
      { app := component
        naturality := by
          ...
          have secondCompatibility :
            ...
            simpa only [edgeFunctor, sourceSecondComparison,
              targetSecondComparison, component, Functor.comp_map,
          ...
          have firstCompatibility :
            ...
            simpa only [edgeFunctor, sourceFirstComparison,
              targetFirstComparison, component, Functor.comp_map,
              Functor.map_preimage] using
              ((SourcePointedAnabelioidHom.finiteTemperificationPullbackIso
          ...
          have middleEquality :
            ...
            simpa only [sourceFirstComparison, sourceSecondComparison,
              ...
              Category.assoc] using countableNaturality
