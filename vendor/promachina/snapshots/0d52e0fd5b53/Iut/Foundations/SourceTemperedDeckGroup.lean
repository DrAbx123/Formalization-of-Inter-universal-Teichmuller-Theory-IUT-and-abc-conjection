...
/-- Every object in the actual Galois deck diagram is countable under the
finite-base hypotheses of the paper. -/
...
noncomputable abbrev TemperedDeckGroup
    [Finite diagram.base.Vertex] [Finite diagram.base.Edge] : Type (u + 1) :=
