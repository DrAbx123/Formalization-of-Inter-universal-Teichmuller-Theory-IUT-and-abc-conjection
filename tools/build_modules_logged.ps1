param(
  [string[]]$Modules = @(
    ...
    'Iut/Foundations/SourceModelFrobenioid.lean',
    'Iut/Foundations/SourceModelFrobenioidDivisorOrder.lean',
    'Iut/Foundations/SourceModelFrobenioidFactorization.lean',
    'Iut/Foundations/SourceModelFrobenioidFactorizationUniqueness.lean',
    'Iut/Foundations/SourceModelFrobenioidPreStepFactorization.lean',
    'Iut/Foundations/SourceModelFrobenioidAxioms.lean',
    'Iut/Foundations/SourceModelFrobenioidPresentation.lean',
    'Iut/Foundations/SourceFrobenioidModelType.lean',
    'Iut/Foundations/SourceModelRationalMonoidTransport.lean',
    'Iut/Foundations/SourceModelFrobenioidPreModel.lean',
    'Iut/Foundations/SourceModelFrobenioidBirational.lean',
    'Iut/Foundations/SourceModelFrobenioidFilteredBirational.lean',
    'Iut/Foundations/SourceModelFrobenioidColimitStructure.lean',
    'Iut/Foundations/SourceModelFrobenioidBirationalDictionary.lean',
    'Iut/Foundations/SourceModelFrobenioidBirationalDivisor.lean',
    'Iut/Foundations/SourceModelFrobenioidBirationalAxioms.lean',
    'Iut/Foundations/SourceModelFrobenioidColimitAxioms.lean',
    'Iut/Foundations/SourceModelFrobenioidRationalNaturality.lean',
    'Iut/Foundations/SourceModelFrobenioidZeroEvaluation.lean',
    'Iut/Foundations/SourceMLFIntegralMonoid.lean',
    'Iut/Foundations/SourceFinitePlaceMLFBase.lean',
    'Iut/Foundations/SourceDefinition52LocalReconstruction.lean',
    'Iut/Foundations/SourceDefinition52LocalContinuity.lean',
    'Iut/Foundations/SourceDefinition52LocalJointContinuity.lean',
    'Iut/Foundations/SourceTopologicalMonoidPresentation.lean',
    'Iut/Foundations/SourceDefinition52IndSystem.lean',
    'Iut/Foundations/SourceDefinition52Sequential.lean',
    'Iut/Foundations/SourceFrobenioidRationalMonoidTransport.lean',
    'Iut/Foundations/SourceFrobenioidIsotropicBase.lean',
    'Iut/Foundations/SourceFrobenioidCoAngularBaseChange.lean',
    'Iut/Foundations/SourceFrobenioidBasePullbackLift.lean',
    'Iut/Foundations/SourceFrobenioidUniversalProEvaluation.lean',
    ...
    'LeanFormal/IUT/IUTII/Frobenioid/MLFIntegralMonoidComparison.lean',
